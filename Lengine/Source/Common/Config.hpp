...
#define CONFIG_TOKENS_SHIPPING S,H,P
...
#define CONFIG_TAG_SHIPPING COMBINE(WRAP(STR,COMBINE(CONFIG_TOKENS_SHIPPING)))
#define CONFIG_NAME_DEBUG "DEBUG"
#define CONFIG_NAME_RELEASE "RELEASE"
#define CONFIG_NAME_SHIPPING "SHIPPING"
#define CONFIG_ID_DEBUG 0
#define CONFIG_ID_RELEASE 1
#define CONFIG_ID_SHIPPING 2
	...
	#define CONFIG_TOKENS CONFIG_TOKENS_SHIPPING
	#define CONFIG_NAME CONFIG_NAME_SHIPPING
	#define CONFIG_TAG CONFIG_TAG_SHIPPING
	#define CONFIG_ID CONFIG_ID_SHIPPING
#endif
