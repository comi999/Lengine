...
public:
	...
	const AnimationChannel& GetChannel( const size_t a_Index ) const { return const_cast< Animation* >( this )->GetChannel( a_Index ); }
	// Get channel by index.
	AnimationChannel& GetChannel( const size_t a_Index ) { return m_Channels[ a_Index ]; }

	// Get channel by index.
	const AnimationChannel& GetChannel( const string& a_Name ) const { return const_cast< Animation* >( this )->GetChannel( a_Name ); }
	// Get channel by index.
...
public:
	...
	using FrameType						= AnimationFrame;
	using PositionType					= Animation::PositionType;
	using RotationType					= Animation::RotationType;
	using ScaleType						= Animation::ScaleType;
	using TimeType						= Animation::TimeType;
	using PositionTrackType				= Animation::PositionTrackType;
	using RotationTrackType				= Animation::RotationTrackType;
	using ScaleTrackType				= Animation::ScaleTrackType;
	using PositionKeyFrameType			= Animation::PositionKeyFrameType;
	using RotationKeyFrameType			= Animation::RotationKeyFrameType;
	using ScaleKeyFrameType				= Animation::ScaleKeyFrameType;
...
public:
	...
	AnimationHead( const Animation& a_Animation )
