...
DECLARE_INITIALIZER( FileIOSystemRegistration );

//==========================================================================
// Talks to the PlatformFileSystem.
//==========================================================================
class FileIOSystem final : public IOSystem
{
public:

	static constexpr Name RootTag = "file"_N;

	FileIOSystem() = default;
	~FileIOSystem() override = default;
