...
namespace ImGui
{
    ...
    IMGUI_API bool          DragFloatXYZ(bool IsColor, const char* label, float v[3], float v_speed = 1.0f, float v_min = 0.0f, float v_max = 0.0f, const char* display_format = "%.3f", float power = 1.0f);
...
struct ImGuiInputTextCallbackData
{
    ...
    // m_Args for the different callback events
